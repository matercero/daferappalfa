...
<html lang="es-ES">
    <head>
        ...
        echo $this->Html->css('jquery.timeentry');
        echo $this->Html->css('jquery.dateentry');
        echo $scripts_for_layout;
        echo $javascript->link(array('prototype'));
        echo $this->Javascript->link('jquery-1.6.2.min');
        echo $this->Javascript->link('jquery.timeentry');
        echo $this->Javascript->link('jquery.dateentry.min');
        echo $this->Javascript->link('jquery.dateentry-es');
