<div class="albaranesclientesreparaciones">
    <h2>
        ...
        <?php echo $this->Html->link(__('Imprimir', true), array('action' => 'pdf', $albaranesclientesreparacione['Albaranesclientesreparacione']['id']), array('class' => 'button_link')); ?> 
         <?php echo $this->Html->link(__('Imp-presupuesto', true), array('action' => 'pdf_presupuesto_alb', $albaranesclientesreparacione['Albaranesclientesreparacione']['id']), array('class' => 'button_link')); ?> 
    ...
    <table class="view edit">
        ...
        <tr>
            ...
            <td>
                <?php echo $this->Html->link($albaranesclientesreparacione['Maquina']['nombre'], array('controller' => 'maquinas', 'action' => 'view', $albaranesclientesreparacione['Maquina']['id'])); ?>
                <label>Horas Máquina: </label><?php echo $albaranesclientesreparacione['Albaranesclientesreparacione']['horas_maquina']; ?>
            </td>
                                    ...
                                    <?php if (!empty($tarea['TareasAlbaranesclientesreparacionesParte'])): ?>
                                        <?php foreach ($tarea['TareasAlbaranesclientesreparacionesParte'] as $partecentro): ?>
                                            <tr>    
                                                ...
                                                <td><?php echo $this->Time->format('d-m-Y', $partecentro['fecha']) ?></td>
                                                <td><?php echo (!empty($partecentro['Mecanico'])) ? $partecentro['Mecanico']['nombre'] : '' ?></td>
                                                <td><span title="<?php echo $partecentro['operacion'] ?>"><?php echo substr($partecentro['operacion'], 0, 40) ?>...</span></td>
                                                <td>
                                                    <?php
                                                ...
                                                <td>
                                                    <?php
                                                    echo ($partecentro['horasdesplazamientoimputables_ida'] + $partecentro['horasdesplazamientoimputables_vuelta']) * $albaranesclientesreparacione['Ordene']['Centrostrabajo']['preciohoradesplazamiento'];
                                                    ?>
                                                </td>
                                                <td>
                                                    <?php
                                                ...
                                                <td>
                                                    <?php
                                                    echo ($partecentro['kilometrajeimputable_ida'] + $partecentro['kilometrajeimputable_vuelta']) * $albaranesclientesreparacione['Ordene']['Centrostrabajo']['preciokm'];
                                                    ?>
                                                </td>
                                                ...
                                                <td><?php echo $partecentro['horasimputables'] * $albaranesclientesreparacione['Ordene']['Centrostrabajo']['preciohoraencentro'] ?></td>
                                                <td class="columna-presupuestado"></td>
                                    ...
                                    <tr>
                                        <td colspan="12" style="font-weight: bold; text-align: center;">
                                            <p style="font-style: italic; font-weight: normal; color: red;">
                                                ...
                                                <?php if ($albaranesclientesreparacione['Ordene']['Centrostrabajo']['modofacturacion'] == 'preciokm'): ?>
                                                    Precio por Kilometro (* No se tendrá en cuenta el Precio de Desplazamiento Fijo)
                                                <?php elseif ($albaranesclientesreparacione['Ordene']['Centrostrabajo']['modofacturacion'] == 'preciofijio'): ?>
                                    ...
                                    <?php if (!empty($tarea['TareasAlbaranesclientesreparacionesPartestallere'])): ?>
                                        <?php foreach ($tarea['TareasAlbaranesclientesreparacionesPartestallere'] as $partetaller): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $this->Time->format('d-m-Y', $partetaller['fecha']) ?></td>
                                                ...
                                                <td><?php echo ($partetaller['horasimputables'] * $albaranesclientesreparacione['Ordene']['Centrostrabajo']['preciohoraentraller']) ?></td>
                                                <td class="columna-presupuestado"></td>
            ...
            <tbody>
                ...
                if (!empty($albaranesclientesreparacione['Ordene']['id'])):
                    ...
                    <tr <?php echo $class ?>>
                        ...
                        <td><?php echo $albaranesclientesreparacione['Ordene']['Cliente']['nombre'] ?></td>
