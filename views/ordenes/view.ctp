<div class="ordenes">
    <h2>
        ...
        <?php echo $this->Html->link(__('Imprimir', true), array('action' => 'pdf_orden', $ordene['Ordene']['id']), array('class' => 'button_link')); ?>
		...
		<?php echo $this->Html->link(__('Imp. Entrega', true), array('action' => 'pdf', $ordene['Ordene']['id']), array('class' => 'button_link')); ?>
    ...
    <table class="view">
        ...
        <tr>
            <td>
                <span>Fecha</span>
                <?php echo!empty($ordene['Ordene']['fecha']) ? $this->Time->format('d-m-Y', $ordene['Ordene']['fecha']) : '' ?>
            </td>
            <td colspan="2">
                <span>Estado</span>
            ...
            <td>
                ...
                <?php echo!empty($ordene['Ordene']['fecha_prevista_reparacion']) ? $this->Time->format('d-m-Y', $ordene['Ordene']['fecha_prevista_reparacion']) : '' ?>
            </td>
        </tr>
        <tr>
			<td>
                <span>Mantenimiento, horas:<span></span><span style="color: green"> 
                <?php echo $ordene['Ordene']['mantenimientos'] ?>
            </td>
            <td colspan="2">
                <span>Fecha de Aceptación</span>
                <?php echo!empty($ordene['Avisostallere']['fechaaceptacion']) ? $this->Time->format('d-m-Y', $ordene['Avisostallere']['fechaaceptacion']) : '' ?>
            </td>
            <td colspan="3">
                <span>Urgente</span>
        ...
        <tr>
            ...
            <td>
                <span>Centro</span>
                <?php echo $this->Html->link($ordene['Centrostrabajo']['centrotrabajo'], array('controller' => 'centrostrabajos', 'action' => 'view', $ordene['Centrostrabajo']['id'])) ?>
            </td>
            <td>
                <p>
                    <span>Máquina</span>
                ...
                <p>
                    <span>Horas</span>
                    <?php echo $ordene['Ordene']['horas_maquina'] ?>
                </p>
            </td>
            <td>
                <p>
        ...
        <tr>   
			<td>
                <span>Fecha entrega trabajos (IMPORTANTE, ACTUALIZAR FECHA ENTREGA):</span>
                <?php echo!empty($ordene['Ordene']['fecha_entrega']) ? $this->Time->format('d-m-Y', $ordene['Ordene']['fecha_entrega']) : '' ?>
			</td>
			<td style="font-size: 160%;">
				<span><?php echo $ordene['Cliente']['riesgos']== 0 ? '' : '<span style="color: red">RIESGO SUPERADO</span>'; ?></td>
            <td><span><?php __('Archivo adjunto'); ?></span></td>
            <td colspan="9"><?php echo $this->Html->link(__($ordene['Ordene']['ordenescaneada'], true), '/files/ordene/' . $ordene['Ordene']['ordenescaneada']); ?></td>
		</tr>
		<tr>
			<td colspan="4">
                <span>Entrega Trabajos:</span> 
                <?php echo $ordene['Ordene']['entregatrabajo'] ?> 
            </td>
        </tr>
    </table>
    <div style="margin: 20px">
        <?php if ($ordene['Estadosordene']['id'] == 1): ?>
                ...
                foreach ($ordene['Tarea'] as $tarea):
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td class="actions" style="background-color: #FACC2E">
                            ...
                            <?php echo $this->Form->create('Tarea', array('action' => 'pdf', 'style' => 'clear: none; margin: 0;display: inline;')) ?>
                            <?php echo $this->Form->hidden('id', array('value' => $tarea['id'])); ?>
                            <?php echo $this->Form->submit('Impr.', array('div' => False)) ?>
                            <?php echo $this->Form->create('Tarea', array('action' => 'pdf2', 'style' => 'clear: none; margin: 0;display: inline;')) ?>
                            <?php echo $this->Form->hidden('id', array('value' => $tarea['id'])); ?>
                            <?php echo $this->Form->submit('Imprimir a cliente', array('div' => False)) ?>
                    ...
                    <tr class="tarea-relations<?php echo $tarea['id'] == $tarea_visualizar_id ? ' show-tarea' : '' ?>">
                                    ...
                                    <?php if (!empty($tarea['Parte'])): ?>
                                        <?php foreach ($tarea['Parte'] as $partecentro): ?>
                                            <tr>    
                                                ...
                                                <td><?php echo!empty($partecentro['fecha']) ? $this->Time->format('d-m-Y', $partecentro['fecha']) : '' ?></td>
                                                <td><?php echo (!empty($partecentro['Mecanico'])) ? $partecentro['Mecanico']['nombre'] : '' ?></td>
                                                <td style="font-size: 0.6em;" title="<?php echo $partecentro['operacion'] ?>"><?php echo substr($partecentro['operacion'], 0, 50) ?>...</td>
                                                <td>
                                                    <?php
                                                ...
                                                <td><?php echo ($partecentro['horasimputables'] * $partecentro['preciohoraencentro']) * (1 - $partecentro['descuento_manodeobra'] / 100) ?></td>
                                                <td class="columna-presupuestado"></td>
                                                ...
                                                <td class="actions">
                                                    ...
                                                    <?php echo $this->Html->link(__('Eliminar', true), array('controller' => 'partes', 'action' => 'delete', $partecentro['id']), null, sprintf(__('Va a eliminar el parte de Trabajo Nº # %s ¿Está seguro?', true), $partecentro['numero'])); ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                    ...
                                    <?php if (!empty($tarea['Partestallere'])): ?>
                                        <?php foreach ($tarea['Partestallere'] as $partetaller): ?>
                                            <tr>
                                                ...
                                                <td><?php echo!empty($partetaller['fecha']) ? $this->Time->format('d-m-Y', $partetaller['fecha']) : '' ?></td>
                                                <td><?php echo $partetaller['Mecanico']['nombre'] ?></td>
                                                <td style="font-size: 0.6em;" title="<?php echo $partetaller['operacion'] ?>"><?php echo substr($partetaller['operacion'], 0, 50) ?>...</td>
                                                <td>
                                                    <?php
                                                ...
                                                <td><?php echo ($partetaller['horasimputables'] * $partetaller['preciohoraentraller']) * (1 - $partetaller['descuento_manodeobra'] / 100) ?></td>
                                                <td class="columna-presupuestado"></td>
                                                ...
                                                <td class="actions">
                                                    ...
                                                    <?php echo $this->Html->link(__('Eliminar', true), array('controller' => 'partestalleres', 'action' => 'delete', $partetaller['id']), null, sprintf(__('Va a eliminar el Parte de Trabajo Nº # %s ¿Está seguro?', true), $partetaller['numero'])); ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                ...
                                <table>
                                    ...
                                    <?php foreach ($tarea['ArticulosTarea'] as $articulo_tarea): ?>
                                        <tr>
                                            ...
                                            <td><?php echo redondear_dos_decimal($articulo_tarea['cantidad'] * $articulo_tarea['precio_unidad']) ?></td>
                                            ...
                                            <td>
                                                <?php echo $this->Form->input('ArticulosTarea.id', array('type' => 'checkbox', 'label' => False, 'name' => 'data[ArticulosTarea][ids][]', 'hiddenField' => False, 'value' => $articulo_tarea['id'])) ?>
                                            </td>
                                            <td class="actions">
                                    ...
                                    <?php endforeach; ?>
                                    <tr>
                                        <td colspan="4" style="text-align: right;" class="total_articulos">Totales</td>
            ...
            <tbody>
                ...
                foreach ($ordene['Presupuestoscliente'] as $presupuestoscliente):
                    ...
                    <tr <?php echo $class ?>>
                        ...
                        <td>
                            <?php echo $this->Html->link('Nuevo Albarán de Reparación con Datos Presupuestados', array('controller' => 'albaranesclientesreparaciones', 'action' => 'add', $ordene['Ordene']['id'], $presupuestoscliente['id']), array('class' => 'button_css_blue')) ?>
                            <?php echo $this->Html->link('Ver', array('controller' => 'presupuestosclientes', 'action' => 'view', $presupuestoscliente['id']), array('class' => 'button_brownie')) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
                <?php
