    ...
    <fieldset>
        ...
        <table class="view">
			...
			<td>
                ...
                <?php echo $this->Form->input('fecha_entrega', array('dateFormat' => 'DMY', 'label' => false)); ?>
			</td>
			</tr> 
            <tr>
                <td colspan="4">
                    <span>Entrega Trabajo</span> 
                    <?php echo $this->Form->input('entregatrabajo', array('label' => false)); ?>
                </td>
            </tr>
            <tr>
                <td colspan="4">
